...
@Autonomous(name = "PedroPathing Blue - Fixed")
@Disabled
public class PedroPathing_Back extends OpMode {
    ...
    public enum PathState {
        ...
        // SHOOT > SCORING
        DRIVE_STARTPOS_OUTPOS,
        DRIVE_OUTPOS_PARKPOS,
        IDLE
    }
...
//                break;
    ...
    @Override
    public void init() {
        pathState = PathState.DRIVE_STARTPOS_OUTPOS;
        pathTimer = new Timer();
